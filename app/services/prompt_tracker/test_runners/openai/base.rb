...
module PromptTracker
  module TestRunners
    module Openai
      ...
      #
      # Provides common functionality for running tests on OpenAI testables
      # (Assistants, Response API conversations, etc.)
      #
      ...
      class Base
        ...
        # @param testable [Object] the testable object (Assistant, PromptVersion, etc.)
