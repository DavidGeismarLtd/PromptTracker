...
module PromptTracker
  module RemoteEntity
    module Openai
      module Assistants
        # Service for creating a new Prompt and AgentVersion from OpenAI Assistant data.
        #
        # This service handles the initial import of an assistant:
        # - Creates a new Prompt record
        # - Creates a new AgentVersion record with the assistant's configuration
        #
        # Use case:
        # - Importing assistants from OpenAI into PromptTracker for the first time
        # - Used by SyncOpenaiAssistantsToAgentVersionsService for bulk imports
        #
        # @example Create from assistant data
        #   result = CreateAsAgentVersionService.call(assistant_data: data)
        #   result.success? # => true
        #   result.prompt # => Prompt
        #   result.agent_version # => AgentVersion
        #
        class CreateAsAgentVersionService
          Result = Data.define(:success?, :prompt, :agent_version, :errors)
          ...
          # @return [Result] result with success?, prompt, agent_version, errors
          ...
          # Create the Prompt and AgentVersion.
          #
