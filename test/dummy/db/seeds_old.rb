...
puts "  - #{PromptTracker::AgentVersion.count} prompt versions"
puts "    - #{PromptTracker::AgentVersion.active.count} active"
puts "    - #{PromptTracker::AgentVersion.draft.count} draft"
puts "    - #{PromptTracker::AgentVersion.deprecated.count} deprecated"
