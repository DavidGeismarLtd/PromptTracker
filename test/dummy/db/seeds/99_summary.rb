...
puts "\n✅ Seeding complete!"
puts "\nCreated:"
puts "  - #{PromptTracker::Agent.count} agents"
puts "  - #{PromptTracker::AgentVersion.count} agent versions"
...
puts "    - #{PromptTracker::Test.where(testable_type: 'PromptTracker::AgentVersion').count} for agent versions"
...
puts "\n🎉 Ready to explore!"
puts "\n💡 Tips:"
puts "  - Visit /prompt_tracker to see all agents"
