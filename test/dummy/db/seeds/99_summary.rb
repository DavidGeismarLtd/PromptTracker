...
puts "    - #{PromptTracker::Trace.running.count} running"
puts "    - #{PromptTracker::Trace.with_errors.count} with errors"
puts "    - #{PromptTracker::Trace.distinct.count(:session_id)} unique sessions"
puts "  - #{PromptTracker::Span.count} spans"
puts "    - #{PromptTracker::Span.root_level.count} root level"
puts "    - #{PromptTracker::Span.where.not(parent_span_id: nil).count} nested"
...
puts "  - Explore tracing features:"
puts "    • View sessions at /prompt_tracker/sessions"
puts "    • View traces at /prompt_tracker/traces"
puts "    • See nested spans in trace details"
puts "    • Check running, completed, and error traces"
