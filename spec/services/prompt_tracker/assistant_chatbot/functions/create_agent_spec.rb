...
RSpec.describe PromptTracker::AssistantChatbot::Functions::CreateAgent do
  let(:context) { {} }
  ...
  describe "#call" do
    ...
    it "prefers explicit user_prompt over generated one" do
      ...
      version = PromptTracker::Agent.last.agent_versions.last
